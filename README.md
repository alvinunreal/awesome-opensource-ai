...
- **[MIT Introduction to Deep Learning](https://github.com/MITDeepLearning/introtodeeplearning)** ![GitHub stars](https://img.shields.io/github/stars/MITDeepLearning/introtodeeplearning?style=social) - MIT 6.S191 official lab materials and code. Introduction to deep learning with hands-on TensorFlow labs covering fundamentals, computer vision, NLP, and generative models. MIT licensed.
