...
- **[Jina](https://github.com/jina-ai/serve)** ![GitHub stars](https://img.shields.io/github/stars/jina-ai/serve?style=social) - Cloud-native neural search framework for building multimodal AI applications. High-performance microservice architecture with gRPC, HTTP, and WebSocket support. Scales from local development to production with Docker and Kubernetes integration. Apache 2.0 licensed.
...
- **[rerankers (Answer.AI)](https://github.com/AnswerDotAI/rerankers)** ![GitHub stars](https://img.shields.io/github/stars/AnswerDotAI/rerankers?style=social) - Lightweight unified API for all common reranking and cross-encoder models. Supports RankGPT, ColBERT, FlashRank, and API-based rerankers with dependency-free core. Apache 2.0 licensed.
