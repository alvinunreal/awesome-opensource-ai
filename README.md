...
- **[Equinox](https://github.com/patrick-kidger/equinox)** ![GitHub stars](https://img.shields.io/github/stars/patrick-kidger/equinox?style=social) - Elegant neural networks and scientific computing in JAX. PyTorch-like syntax with filtered transformations and advanced PyTree manipulation. Models are just PyTrees - seamlessly compatible with all JAX transformations. Apache 2.0 licensed.
- **[Haiku](https://github.com/google-deepmind/dm-haiku)** ![GitHub stars](https://img.shields.io/github/stars/google-deepmind/dm-haiku?style=social) - JAX-based neural network library from Google DeepMind. Simple, explicit API for building and training neural networks with state-of-the-art results in image and language processing. Apache 2.0 licensed.
...
- **[GGML](https://github.com/ggml-org/ggml)** ![GitHub stars](https://img.shields.io/github/stars/ggml-org/ggml?style=social) - Tensor library for machine learning. Low-level cross-platform implementation with integer quantization, automatic differentiation, and zero memory allocations at runtime. Powers llama.cpp and the GGUF ecosystem. MIT licensed.

#### C++ ML Frameworks

- **[Flashlight](https://github.com/flashlight/flashlight)** ![GitHub stars](https://img.shields.io/github/stars/flashlight/flashlight?style=social) - Fast, flexible machine learning library written entirely in C++ from Meta AI Research. Created by the team behind Torch and TensorFlow with focus on simplicity and extensibility. MIT licensed.
- **[oneDNN](https://github.com/uxlfoundation/oneDNN)** ![GitHub stars](https://img.shields.io/github/stars/uxlfoundation/oneDNN?style=social) - oneAPI Deep Neural Network Library. Open-source cross-platform performance library of basic building blocks for deep learning, optimized for Intel, AMD, and ARM processors. Used by PyTorch, TensorFlow, and ONNX Runtime. Apache 2.0 licensed.
