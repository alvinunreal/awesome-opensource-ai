...
- **[gp.nvim](https://github.com/Robitx/gp.nvim)** ![GitHub stars](https://img.shields.io/github/stars/Robitx/gp.nvim?style=social) - Neovim AI plugin for ChatGPT sessions, instructable text/code operations, and speech-to-text. Supports OpenAI, Ollama, Anthropic, and more. MIT licensed.
...
- **[opencommit](https://github.com/di-sukharev/opencommit)** ![GitHub stars](https://img.shields.io/github/stars/di-sukharev/opencommit?style=social) - Feature-rich GPT wrapper for git that generates conventional commit messages with multiple LLM providers including local Ollama models. Supports GitMoji and detailed change explanations. MIT licensed.
- **[readme-ai](https://github.com/eli64s/readme-ai)** ![GitHub stars](https://img.shields.io/github/stars/eli64s/readme-ai?style=social) - README file generator powered by AI. Create detailed, structured documentation with multiple templates, badges, and support for various LLM providers. MIT licensed.
- **[Mintlify Writer](https://github.com/mintlify/writer)** ![GitHub stars](https://img.shields.io/github/stars/mintlify/writer?style=social) - AI-powered documentation writer that generates comprehensive docs from your codebase. Supports multiple programming languages and integrates with popular IDEs. MIT licensed.
...
- **[Keploy](https://github.com/keploy/keploy)** ![GitHub stars](https://img.shields.io/github/stars/keploy/keploy?style=social) - Developer-centric API and integration testing platform that auto-generates tests and data-mocks. Creates safe, isolated production sandboxes for comprehensive testing. Apache 2.0 licensed.
