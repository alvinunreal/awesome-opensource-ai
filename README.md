...
- **[Typesense](https://github.com/typesense/typesense)** ![GitHub stars](https://img.shields.io/github/stars/typesense/typesense?style=social) - Fast, typo-tolerant search engine optimized for instant search experiences. In-memory search with built-in vector search, faceting, and geosearch capabilities. GPL-3.0 licensed.
- **[USearch](https://github.com/unum-cloud/USearch)** ![GitHub stars](https://img.shields.io/github/stars/unum-cloud/USearch?style=social) - Fast open-source search and clustering engine for vectors and arbitrary objects. Single-file implementation with 10-100x speedup over FAISS on billion-scale datasets. Apache 2.0 licensed.
- **[sqlite-vec](https://github.com/asg017/sqlite-vec)** ![GitHub stars](https://img.shields.io/github/stars/asg017/sqlite-vec?style=social) - Vector search SQLite extension that runs anywhere. Zero-dependency, portable vector database for edge devices and embedded applications. Apache 2.0 licensed.
- **[hnswlib](https://github.com/nmslib/hnswlib)** ![GitHub stars](https://img.shields.io/github/stars/nmslib/hnswlib?style=social) - Header-only C++/Python library for fast approximate nearest neighbors using HNSW algorithm. Lightweight, efficient ANN index for production RAG pipelines. Apache 2.0 licensed.
- **[Jina](https://github.com/jina-ai/jina)** ![GitHub stars](https://img.shields.io/github/stars/jina-ai/jina?style=social) - Neural search framework for building multimodal AI applications. Production-grade vector search, embeddings, and reranking with cloud-native orchestration. Apache 2.0 licensed.
