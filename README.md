...
- **[PageIndex](https://github.com/VectifyAI/PageIndex)** ![GitHub stars](https://img.shields.io/github/stars/VectifyAI/PageIndex?style=social) - Vectorless, reasoning-based RAG system that builds hierarchical tree indices from documents and uses LLM reasoning for human-like retrieval. Eliminates vector DBs and chunking through agentic tree search.
