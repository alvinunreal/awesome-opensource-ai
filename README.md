...
- **[GPT4All](https://github.com/nomic-ai/gpt4all)** ![GitHub stars](https://img.shields.io/github/stars/nomic-ai/gpt4all?style=social) - Run Local LLMs on any device. Cross-platform desktop application with a modern chat UI, local model management, and OpenAI-compatible API server. MIT licensed.
