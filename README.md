...
- **[Mistral Small 4 (Mistral AI)](https://huggingface.co/mistralai/Mistral-Small-4-119B-2603)** - Released March 2026. 119B MoE (6.5B active) with 256k context, unified instruct/reasoning/multimodal capabilities, and Apache 2.0 license. 3x faster than Small 3 with 40% latency reduction.
